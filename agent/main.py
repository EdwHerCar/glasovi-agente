...
app = FastAPI(
    title="Glasovi — WhatsApp AI Agent | Plaza de Salud Glasovi",
    version="1.0.0",
    lifespan=lifespan
)
...
async def health_check():
    ...
    return {"status": "ok", "service": "glasovi-agentkit"}
...
async def webhook_handler(request: Request):
    ...
    try:
        ...
        for msg in mensajes:
            ...
            # Generar respuesta con Claude (pasando el teléfono para tool use de citas)
